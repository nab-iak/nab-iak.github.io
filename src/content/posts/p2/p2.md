---
title: 'RNA-seq Analysis Service from University of Tsukuba'
...
- If you wish to proceed with the request below, please complete the Sample Request Sheet (Excel file) and send it to us. The person in charge will respond with the shipping address and other instructions.
- Note: Samples will not be returned. Thank you for your understanding.

---

## RNA-seq Analysis Plan 1: from Extraction and Purification to Data Analysis (44,300 yen/sample)
...
## RNA-seq Analysis Plan 2: from Purified RNA to Data Analysis (37,150 yen/sample)
...
## RNA-seq Analysis Plan 3: from Quality-checked RNA to Data Analysis (25,020 yen/sample)

## RNA-seq Analysis Plan 4: from Quality-checked RNA to FASTQ Delivery (20,940 yen/sample)
...
## Bioinformatics Analysis Support (4,010 yen/sample)
