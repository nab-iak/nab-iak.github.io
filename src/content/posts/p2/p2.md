...
>
## <center>RNA-seq Analysis Service from University of Tsukuba</center>

- This RNA-seq analysis services as a part of the Open Facility Program, University of Tsukuba.
- If you wish to proceed with the request below, please complete the [Sample Request Sheet (Excel file)]('./RNA-Seq-Request-Form_EN.xlsx') and send it to us. The person in charge will respond with the shipping address and other instructions.
