import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, i as escape, j as AstroUserError, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, a as renderComponent } from './astro/server_UGlnaItR.mjs';
...
var LinkPreset = /* @__PURE__ */ ((LinkPreset2) => {
  ...
  LinkPreset2[LinkPreset2["Work"] = 3] = "Work";
  LinkPreset2[LinkPreset2["Activity"] = 4] = "Activity";
  return LinkPreset2;
})(LinkPreset || {});
...
const siteConfig = {
  ...
  banner: {
    ...
    credit: {
      ...
      text: "Cover Pic by @BLACKmeow",
      // Credit text to be displayed
      url: "http://www.pixiv.net/artworks/120779486"
  ...
  links: [
    {
      ...
      url: "https://x.com/wujiaoshuiduole"
    },
    {
      name: "Discord",
      icon: "fa6-brands:discord",
      url: "https://discord.gg/kXCRZH9Zrg"
    },
    {
      name: "GitHub",
      icon: "fa6-brands:github",
      url: "https://github.com/nab-iak"
    }
  ]
};
const licenseConfig = {
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Bt63Gi4J.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://nab-iak.github.io", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_yYc-Vnvo.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BP6Q5xOR.mjs').then(n => n._);
...
export { DEFAULT_OUTPUT_FORMAT as D, I18nKey as I, LinkPreset as L, VALID_SUPPORTED_FORMATS as V, getSortedPosts as a, getCategoryList as b, getTagList as c, defineCollection as d, isRemotePath as e, DEFAULT_HASH_PROPS as f, getEntry as g, config$1 as h, i18n as i, joinPaths as j, config as k, licenseConfig as l, i18nKey as m, navBarConfig as n, en$1 as o, profileConfig as p, es$1 as q, renderEntry as r, siteConfig as s, ja$1 as t, ko$1 as u, th$1 as v, zh_TW$1 as w, translation as x, contentUtils as y, zh_CN$1 as z };
